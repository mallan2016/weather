$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "The weather today is "+data.currently.summary+". Tomorrow will be "+data.daily.data[1].summary+" The day after that will be "+data.daily.data[2].summary+" and the day after that will be "+data.daily.data[3].summary;
